...
urlpatterns = [
    path("", views.PollList.as_view(), name="form_list"),
    ...
    path(
        "form/<str:code>/edit_description",
        views.edit_description,
        name="edit_description",
    ),
    path(
        "form/<str:code>/edit_background_color",
        views.edit_bg_color,
        name="edit_background_color",
    ),
    path(
        "form/<str:code>/edit_text_color", views.edit_text_color, name="edit_text_color"
    ),
    ...
    path(
        "form/<str:code>/get_choice/<str:question>", views.get_choice, name="get_choice"
    ),
    path("form/<str:code>/add_question", views.add_question, name="add_question"),
    path(
        "form/<str:code>/delete_question/<str:question>",
    ...
    path(
        "form/<str:code>/response/<str:response_code>", views.response, name="response"
    ),
    path(
        "form/<str:code>/response/<str:response_code>/edit",
        views.edit_response,
        name="edit_response",
    ),
    path(
        "form/<str:code>/responses/delete",
