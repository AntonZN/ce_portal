document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".input-form-title").forEach(title => {
        title.addEventListener("input", function () {
            ...
            document.title = `${this.value} - Формы опросов`
                            ...
                            if (this.value === "multiple choice" || this.value === "checkbox") {
                                fetch(`get_choice/${this.dataset.id}`, {
                                    ...
                                    <div class="choice">
                                        ...
                                        data-type = "${this.value}">Добавить</label>
                                    </div>`;
        ...
        fetch('add_question', {
            ...
            <div class="choices" data-id="${result["question"].id}">
                ...
                <div class="choice">
                    ...
                    data-type = "${result["question"].question_type}">Добавить</label>
                </div>
            </div>
